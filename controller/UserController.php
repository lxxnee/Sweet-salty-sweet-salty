...
class UserController extends Controller
{
    ...
    {
        $requestData = [
            "u_name" => $_POST["u_name"], "u_pw" => $_POST["u_pw"], "u_pw_chk" => $_POST["u_pw_chk"]
        ];
        ...
        // 유저 정보 업데이트
        $updateData = [
            "u_id" => $_SESSION["u_id"], "u_name" => $requestData["u_name"], "u_pw" => $this->encryptionPassword($requestData["u_pw"], $this->getUserInfo("u_email"))
        ];
        $modelUsers->beginTransaction();
